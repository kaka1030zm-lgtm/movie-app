      ...
      <div className="overflow-x-scroll scrollbar-hide scroll-smooth pb-2">
        <div className="flex space-x-5 pb-4">
          {movies.map((movie) => (
            ...
            >
              <div className="aspect-[2/3] w-full relative rounded-xl overflow-hidden bg-gradient-to-br from-[#1a1a1a] to-[#0a0a0a] border border-white/5 shadow-lg transition-all duration-300 hover:scale-105">
                {movie.poster_path ? (
                  <>
                    <img
